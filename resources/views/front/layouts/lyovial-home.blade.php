...
<meta name="google-site-verification" content="JY7cwsXdycWsc-0izUch9tZly4mo1l5nYZ9_rPh-IPU" />
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-5E7R6QWW9W"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-5E7R6QWW9W');
</script>
<script type="text/javascript">
    ...
    })(window, document, "clarity", "script", "yb2vtzb10f");
</script>
    @php
        $seo = $seo ?? null;

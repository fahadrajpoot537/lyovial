...
@endphp
<link rel="icon" href="{{ $primary }}" type="{{ $type }}">
<link rel="shortcut icon" href="{{ $primary }}" type="{{ $type }}">
<link rel="icon" type="{{ $type }}" sizes="32x32" href="{{ $primary }}">
<link rel="icon" type="{{ $type }}" sizes="16x16" href="{{ $primary }}">
<link rel="apple-touch-icon" sizes="180x180" href="{{ $primary }}">
